...
srcdir = /Users/hadaegyeom/Ruby/Ruby-GUI
topdir = /Users/hadaegyeom/.rvm/rubies/ruby-3.0.0/include/ruby-3.0.0
hdrdir = $(topdir)
arch_hdrdir = /Users/hadaegyeom/.rvm/rubies/ruby-3.0.0/include/ruby-3.0.0/arm64-darwin21
PATH_SEPARATOR = :
VPATH = $(srcdir):$(arch_hdrdir)/ruby:$(hdrdir)/ruby
prefix = $(DESTDIR)/Users/hadaegyeom/.rvm/rubies/ruby-3.0.0
...
DEFS     = 
CPPFLAGS = -DHAVE_RB_OBJ_INSTANCE_EXEC -DHAVE_RB_SYM2STR -DHAVE_RB_ID2STR -DHAVE_RB_ARY_CAT -DHAVE_STRNDUP -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)
...
dldflags = -L/opt/homebrew/opt/libyaml/lib -L/opt/homebrew/opt/libksba/lib -L/opt/homebrew/opt/readline/lib -L/opt/homebrew/opt/zlib/lib -L/opt/homebrew/opt/openssl@1.1/lib -Wl,-undefined,dynamic_lookup -Wl,-multiply_defined,suppress 
ARCH_FLAG = -m64
